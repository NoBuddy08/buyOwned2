...
<% uob=(User)session.getAttribute("uob");
   ...
   rse=obj.GetBooks();
   rse.next();
   application.setAttribute("rs", rse);%>
      ...
      <div class="row items">
        ...
        <div class="product-container col s12 m3">
          ...
          <div class="card sticky-action">
            <div class="card-image waves-effect waves-block waves-light center" style="width: 200px;height: 300px">
              <img class="activator" src="Getimage">
            </div>
            <div class="card-content">
              ...
              <p>
                <div class="card-action">
                  <a href="desc.jsp?sno=<%=rs.getInt(1)%>"><button class="details btn waves-effect waves-light waves-block z-depth-1">See
                      Details</button></a>
                </div>
            </div>
